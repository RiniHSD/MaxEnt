...
*/ 
// Mengimpor data occurrence spesies, data absence spesies, dan data Region of Interest (ROI) 
var dataOccurrence = ee.FeatureCollection('projects/ee-rinihusadiyah/assets/S_OccurrenceFix')
var dataAbsence = ee.FeatureCollection('projects/ee-rinihusadiyah/assets/S_AbsenceTest')
var roi = ee.FeatureCollection('projects/ee-rinihusadiyah/assets/ROI_Jawa')
...
Export.image.toDrive({ 
  ...
  description: 'Kesesuian Habitat Merak Hijau', 
  scale: 100, 
  region: roi, 
  maxPixels: 1E11 
}); 
